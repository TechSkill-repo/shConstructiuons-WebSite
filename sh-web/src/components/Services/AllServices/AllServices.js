  ...
  return (
    <div className="all-services">
      ...
      <div className="all-services-cards">
        ...
        <div className="all-services-cards-card">
          <img
            src="https://cdn.pixabay.com/photo/2019/02/20/17/46/conveyor-belt-4009657_960_720.jpg"
            alt=""
          />
          <div>
            <p className="clip">06.</p>
        ...
        <div className="all-services-cards-card">
          <img
            src="https://images.pexels.com/photos/3785927/pexels-photo-3785927.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
          <div>
            <p className="clip">07.</p>
            <h2>Mega Arc</h2>
            <p className="description">
              Lorem Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
              nobis magni maxime exercitationem natus ab ullam vel quo dicta.
        ...
        <div className="all-services-cards-card">
          <img
            src="https://www.traktechsl.com/wp-content/uploads/2019/04/L%C3%ADnea-transportadora-banda-modular-embalaje-secundario.jpg"
            alt=""
          />
          <div>
            <p className="clip">08.</p>
            <h2>Pallet Plant</h2>
            <p className="description">
              Lorem Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
              nobis magni maxime exercitationem natus ab ullam vel quo dicta.
