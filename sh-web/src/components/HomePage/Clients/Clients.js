  ...
  return (
    <div className='clients p-2'>
      ...
      <div className="clients-left">
        <img src="https://preview.codeless.co/bygge/default/wp-content/uploads/2021/06/dots.png" alt="" />
        <p className="clip">WHAT PEOPLE SAY</p>
        <h1>Client's Talk</h1>
        <p className='clients-para'>We have a wealth of experience working as main building contractors on all kinds of projects, big and small, from home maintenance and improvements to extensions, refurbishments and new builds.</p>
        <button className='homepage-btn'>VIEW MORE <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<img width="80" height="80" src="https://preview.codeless.co/bygge/default/wp-content/uploads/2021/06/user1.png" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" loading="lazy"/> </div>
